...
public class SpeechRecognition : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        recognizedString = "Waiting for microphone permission  qwq qwq...";
        ...
        StartContinuous();
        recognizedString = "StartContinuous  qwq qwq...";
#else
        micPermissionGranted = true;
        StartContinuous();
        recognizedString = "StartContinuous  qwq qwq...";
    ...
    private void RecognizedHandler(object sender, SpeechRecognitionEventArgs e)
    {
        if (e.Result.Reason == ResultReason.RecognizedSpeech)
        {
            ...
            lock (threadLocker)
            {
                ...
                GetComponent<speechCommand>().setString(recognizedString);
            }
        }
